...
function FlatpickrInstance(element, instanceConfig) {
    ...
    function numberifyTextInput(val) {
        if (val === void 0) { val = "0"; }
        val = (val || "0").slice(-2);
    ...
    function convertMinutesAndSeconds(val) {
        if (val === void 0) { val = "0"; }
        var num = numberifyTextInput(val);
        if (num >= 60)
            num = parseInt(val.slice(-1), 10);
        return num;
    }
    function convertHours(val, ampm) {
        if (val === void 0) { val = "0"; }
        var num = numberifyTextInput(val);
        if (ampm) {
            if (num > 12)
    ...
    function setHoursFromInputs() {
        ...
        if (self.amPM &&
            ...
            hours = convertHours(self.hourElement.value, self.amPM && self.amPM.textContent);
        }
        else {
            hours = convertHours(self.hourElement.value);
        }
        var minutes = convertMinutesAndSeconds(self.minuteElement.value);
        var seconds = convertMinutesAndSeconds(self.secondElement && self.secondElement.value);
